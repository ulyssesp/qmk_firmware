...
[_QWERTY] = LAYOUT( \
  ...
  SFT_T(KC_Z),    KC_X,    KC_C,    KC_V,    KC_B,                       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_ESC, \
          ALT_T(KC_ENT), LT(_LOWER, KC_TAB), CTL_T(KC_SPC),    SFT_T(KC_BSPC), LT(_RAISE, KC_ENT), KC_LGUI    \
),

[_GAME] = LAYOUT( \
  KC_T,    KC_Q,    KC_W,    KC_E,    KC_R,                       KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    \
  KC_LCTRL,    KC_A,    KC_S,    KC_D,    KC_G,                       KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, \
  KC_LSFT,    KC_X,    KC_C,    KC_V,    KC_B,                       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_ESC, \
          ALT_T(KC_ENT), LT(_LOWER, KC_TAB), KC_SPC,    SFT_T(KC_BSPC), LT(_RAISE, KC_ENT), QWERTY    \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_DQT,     KC_QUOT,  KC_UNDS, KC_GRV,  _______,      KC_ASTR,  KC_1,     KC_2,   KC_3, KC_SLSH, \
                        GAME, MO(_ADJUST), QWERTY,      _______,  _______,  _______                    \
),


[_LOWER] = LAYOUT( \
  KC_GRV,   KC_HOME, KC_UP,   KC_END,   _______,     KC_LPRN, KC_RPRN, KC_LBRC, KC_RBRC, _______,
  KC_VOLU,  KC_LEFT, KC_DOWN, KC_RIGHT, KC_PGUP,     KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, \
